...
function generateDockerCompose(options) {
  ...
  if (database === 'postgres') {
    ...
    environment:
      ...
      # project and gitignored. Compose fails loudly rather than falling back to
      # a default, so a deployment cannot silently run on a guessable password.
